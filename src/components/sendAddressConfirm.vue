      ...
      <div id="sendAddressConfirm" v-show="myBookShow" ref="mytext">
        ...
        <table border="1" style="width:90%;margin:0 auto" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td colspan="3" style="text-align:left;padding-left:10px;padding-right: 18px;">
              ...
              <yd-checkbox-group size="12" v-model="checkbox5" id="checkType" v-show="check">
                <p>
                  <yd-checkbox val="手机号码" v-model="phone1" :change="listen('手机号码')"><span style="font-size:12px;">手机号码(电子送达必填)</span></yd-checkbox>
                  <yd-input slot="right" v-model="mobile" class="myInput" :show-clear-icon="true"></yd-input>
                </p>
                <p>
                  <yd-checkbox val="电子邮箱"><span style="font-size:12px;">电子邮箱：</span></yd-checkbox>
                  <yd-input
                    slot="right"
                ...
                <p>
                  <yd-checkbox val="微信号"><span style="font-size:12px;">微信号：</span></yd-checkbox>
                  <yd-input
                    slot="right"
                ...
                <p>
                  <yd-checkbox val="微信公众号" style="margin-bottom:8px;"><span style="font-size:12px;">微信公众号</span></yd-checkbox>
                </p>
              </yd-checkbox-group>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3" style="text-align:left;" id="checkAdd">
              <textarea  v-model="resultLitigantData.sendAddress"></textarea>
            </td>
          </tr>
          <tr>
            <td>手机号码</td>
...
export default {
  ...
  methods: {
    ...
    keep() {
      ...
      this.resultLitigantData.target=this.GetRequest('target');
