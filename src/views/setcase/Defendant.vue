...
<div   style="height:100%;background:#F1F2F6">
    <div style="height:100%;background:#F1F2F6">
        <yd-navbar title="被告身份信息" bgcolor="#40a9ff" color="#fff">
            ...
            <yd-cell-group v-if='litigantType==0'>
                ...
                <yd-cell-item>
                    ...
                    <yd-input slot="right" required v-model="identityCard" type="number" max="22" placeholder="210602199996666666"></yd-input>
                </yd-cell-item>
                <yd-cell-item>
                    <span slot="left">手机号码：</span>
                    <yd-input slot="right" required v-model="litigantPhone" type="number" max="11" placeholder=""></yd-input>
                </yd-cell-item>
            </yd-cell-group>
            ...
            <yd-cell-group v-if='litigantType==1'>
                ...
                <yd-cell-item>
                    <span slot="left">手机号码：</span>
                    <yd-input slot="right" required v-model="legalManPhone" type="number" max="11" placeholder=""></yd-input>
                </yd-cell-item>
            </yd-cell-group>
